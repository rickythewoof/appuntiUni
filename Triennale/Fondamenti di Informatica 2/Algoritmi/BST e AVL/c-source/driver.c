...
int main(int argc, char** argv) {
    ...
    if (strcmp(argv[1], "bst") == 0) {
        ...
        bst * b = bst_new(6, (void*)"Pisa");

        bst_insert(b, 3, (void*)"Roma");
        bst_insert(b, 12, (void*)"Milano");
        bst_insert(b, 7, (void*)"Bologna");
        bst_insert(b, 5, (void*)"Firenze");
        bst_insert(b, 1, (void*)"Torino");
        bst_insert(b, 15, (void*)"Siracusa");
        bst_insert(b, 8, (void*)"Bari");
